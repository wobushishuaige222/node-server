module.exports = app => {
    ...
    router.get('/heroes/:id', async (req, res) => {
        const data = await Hero
            ...
            .populate('categories items1 items2 partners.hero restraint.hero continent.hero inscriptionChoice.inscription')
            .lean()
        res.send(data)
    })
